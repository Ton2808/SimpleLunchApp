...
# This will return all the user name and email
@router.get('/get' , description= "Get all user info" , response_model = List[Schemas.showUser])
def getUser(db : Session = Depends(get_db)):
    return db.query(models.user).all()

# This will return the user password if you give it your email
@router.get('/get/password' , description= "Get user password by email" )
...
@router.get('/get/order' , description = "Get all order" , response_model = List[Schemas.showOrder])
...
# You can create multi food in the same store at the same time
@router.post('/order/create' , description = "Create orders" )
def createOrder(login : Schemas.login , order : Schemas.order , db : Session = Depends(get_db)):
